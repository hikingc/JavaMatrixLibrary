...
/// @param rotationPeriodMs how long the session should be used before changing it. `604800000` is the recommended default.
/// @param rotationPeriodMsgs how many messages should be sent before changing the session. `100` is
